...
GT_PATH = '/home/f523/guazai/disk3/shangxiping/redet/dataset/test/testlabel_txt'
DR_PATH = '/home/f523/guazai/disk3/shangxiping/mmrotate/work_dirs/fusion_redet_re50_refpn_1x_llvip_coco_visloss+fre/res/rgb'
...
for class_index, class_name in enumerate(gt_classes):
    ...
    for txt_file in dr_files_list:
        ...
        for line in lines:
            try:
                left, top, right, bottom, confidence, tmp_class_name = line.rstrip('\n').split(' ')
            except ValueError:
                error_msg = "Error: File " + txt_file + " in the wrong format.\n"
