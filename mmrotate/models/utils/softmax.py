...
class Softmax(enn.EquivariantModule):

    def __init__(self, in_type: FieldType, dim=3):
        r"""
    ...
    def forward(self, input: GeometricTensor) -> GeometricTensor:
        ...
        return GeometricTensor(F.softmax(input.tensor, dim=self.dim), self.out_type)
    ...
    def export(self):
        ...
        return torch.nn.Softmax(inplace=self._inplace)
