...
from ..utils import (build_enn_divide_feature, build_enn_norm_layer,
                     ...
                     ennMaxPool, ennReLU, ennTrivialConv, ennInterpolate,
                     build_enn_feature)
import pdb
...
class ReResNet_Fre(BaseModule):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(ReResNet_Fre, self).__init__()
        self.in_type = build_enn_trivial_feature(64)
        ...
        self.up_sample = ennInterpolate(256, 2)

        ######################################################################
        # 64->256
        _in_channels = 64
        _out_channels = base_channels * self.expansion
        self.conv2 = ennTrivialConv(
            _in_channels,
            _out_channels,
            kernel_size=1,
            stride=1,
        ...
        self.conv4 = ennConv(
            ...
            bias=False)
        self.norm2_name, norm2 = build_enn_norm_layer(
            _out_channels, postfix=2)
        self.add_module(self.norm2_name, norm2)
        self.relu2 = ennReLU(_out_channels)
    ...
    def train(self, mode=True):
        ...
        super(ReResNet_Fre, self).train(mode)
        self._freeze_stages()
        # pdb.set_trace()
