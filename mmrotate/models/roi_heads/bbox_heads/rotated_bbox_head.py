...
class RotatedBBoxHead(BaseModule):
    ...
    def _get_target_single(self, pos_bboxes, neg_bboxes, pos_gt_bboxes,
                           pos_gt_labels, gt_bboxes, cfg, img_meta=None):
        ...
        if num_pos > 0:
            ...
            if 'weight_infrared' in img_meta:
                ...
                pos_gt_weightes = self.assign_weight(gt_bboxes_infrared_weights, gt_bboxes, pos_gt_bboxes)
                bbox_weights[:num_pos, :] = pos_gt_weightes
            elif 'weight_rgb' in img_meta:
                gt_bboxes_rgb_weights = img_meta['weight_rgb']
                pos_gt_weightes = self.assign_weight(gt_bboxes_rgb_weights, gt_bboxes, pos_gt_bboxes)
                bbox_weights[:num_pos, :] = pos_gt_weightes
            else:
